...
const es = {
  ...
  home: {
    ...
    headline: "Pega donde no se puede pegar",
    ...
    stepsLead: "Todo el flujo cabe en el tiempo que tardarías en teclear una clave a mano.",
    steps: [
      {
    ...
    featuresLead: "Dos garantías que no dependen de que te acuerdes de nada, y los límites con los que puedes contar.",
    wipeTag: "2 h · 24 h",
    wipeTitle: "Se borra sola",
    wipeBody:
      "Dos horas sin actividad y la sala desaparece con todo lo que llevaba dentro. Nunca más de veinticuatro. No hay botón de guardar porque no hay dónde guardar.",
    approveTag: "Huella de dos palabras",
    approveTitle: "Nadie entra sin que lo apruebes",
    approveBody:
      "Cada intento muestra un par de palabras. Apruebas el que aparece en tu pantalla. Si alguien prueba códigos al azar, el tuyo rota antes de que acierte.",
    features: [
      {
        icon: "file",
        value: "1 GB",
      ...
      },
      {
        ...
        body: "La sala guarda 1 GB entre el texto, las pegadas y los archivos, y enseña abajo cuánto llevas. El volcado de logs, el dump y los tres certificados caben en el mismo sitio.",
      },
      {
        icon: "history",
        value: "10",
    ...
    faq: [
      ...
      {
        q: "¿Y los archivos?",
        a: "Ya están. Hasta 20 por sala, dentro del mismo gigabyte que comparten con el texto y las pegadas. La subida va por trozos y es reanudable: si la sesión se cae a mitad de un binario grande, al volver continúa por donde iba.",
      },
      {
  ...
  room: {
    ...
    pin: "Nueva pegada",
    pinTip: "Alt+N · guarda este texto como una pegada aparte, para que el siguiente no lo pise",
    download: "Descargar",
    ...
    fullPin: "La sala está llena: borra algo antes de fijar otra pegada",
    fullUpload: "La sala está llena: borra algo para subir más",
    pinned: "Fijado como pegada",
    pinnedCleared: "Fijado como pegada, editor vacío",
    entryCopied: "Pegada copiada",
    ...
    language: "Idioma",
    clearOnPin: "Vaciar el editor al fijar",
    yes: "sí",
    no: "no",
    access: "Acceso",
    ...
    wipeBody: "Se borran el texto y las pegadas de todos los que estén dentro. Los archivos se quedan. No se puede deshacer.",
    wipeLabel: "Vaciar",
    wiped: "Sala vaciada",
    close: "Cerrar la sala",
    closeTitle: "¿Cerrar la sala?",
    closeBody:
      "La sala desaparece ahora mismo con el texto, las pegadas y los archivos, y todos los conectados salen. No se puede deshacer.",
    ...
    fullBody: (limit: string) =>
      `${limit} entre el texto, las pegadas y los archivos. Puedes seguir leyéndola y descargando; para enviar algo más, borra lo que ya no necesites.`,
    ...
    emptyPastes:
      "Cada vez que alguien pega algo distinto, lo anterior queda aquí como una pegada aparte. También puedes fijar el texto actual sin esperar a que lo reemplacen.",
    emptyFiles: "Arrastra un archivo a la sala o pulsa Subir. Se borran con ella.",
    copyEntry: "Copiar esta pegada",
    restoreEntry: "Traerla al editor",
    removeEntry: "Quitar esta pegada",
    resume: "Reanudar",
    remove: "Quitar",
    ...
    usageTitle: (used: string, limit: string) => `${used} de ${limit} entre el texto, las pegadas y los archivos`,
    usageOf: (percent: string, limit: string) => `${percent} de ${limit}`,
    unsaved: "sin guardar",
    synced: "sincronizado",
    clock: (left: string) => `se borra en ${left} sin actividad`,
    renewed: " · reiniciado",
    cancel: "Cancelar",
    undo: "Deshacer",
  },
...
const en: typeof es = {
  ...
  home: {
    ...
    headline: "Paste where you can't paste",
    lead: "Five characters on the other screen and what you copied crosses over. No accounts, nothing to install.",
    specCode: "Code",
    specCodeValue: "5 characters",
    specWipe: "Wiped after",
    specWipeValue: "2 h idle",
    specFiles: "Files",
    ...
    wipeBody:
      "Two hours idle and the room disappears with everything it held. Never more than twenty-four. There is no save button because there is nowhere to save.",
    approveTag: "Two-word fingerprint",
    approveTitle: "Nobody gets in without your say-so",
    approveBody:
      "Every attempt shows a pair of words. You approve the one on your screen. If someone is guessing codes at random, yours rotates before they land it.",
    features: [
      {
        icon: "file",
        value: "1 GB",
      ...
      },
      {
        icon: "layers",
        value: "20",
        label: "files per room",
        body: "The room holds 1 GB across the text, the pastes and the files, and shows you at the bottom how much you have used. The log dump, the database dump and the three certificates all fit in the same place.",
      },
      {
        icon: "history",
        value: "10",
        label: "pastes in the history",
        body: "Pasting something new doesn't erase what was there: the room keeps the last ten and you can go back to any of them.",
      },
      {
        icon: "devices",
        value: "16",
    ...
    faq: [
      ...
      {
        q: "What about files?",
        a: "They're here. Up to 20 per room, inside the same gigabyte they share with the text and the pastes. The upload is chunked and resumable: if the session drops halfway through a large binary, it carries on where it was.",
      },
      {
  ...
  room: {
    ...
    pin: "New paste",
    pinTip: "Alt+N · saves this text as a separate paste, so the next one doesn't overwrite it",
    download: "Download",
    ...
    fullPin: "The room is full: delete something before pinning another paste",
    fullUpload: "The room is full: delete something to upload more",
    pinned: "Pinned as a paste",
    pinnedCleared: "Pinned as a paste, editor cleared",
    entryCopied: "Paste copied",
    ...
    language: "Language",
    clearOnPin: "Clear the editor on pin",
    yes: "yes",
    no: "no",
    access: "Access",
    ...
    wipeBody: "The text and the pastes are deleted for everyone inside. The files stay. This cannot be undone.",
    wipeLabel: "Wipe",
    wiped: "Room wiped",
    close: "Close the room",
    closeTitle: "Close the room?",
    closeBody:
      "The room disappears right now along with the text, the pastes and the files, and everyone connected is dropped. This cannot be undone.",
    ...
    fullBody: (limit: string) =>
      `${limit} across the text, the pastes and the files. You can still read it and download; to send anything more, delete what you no longer need.`,
    ...
    emptyPastes:
      "Every time someone pastes something different, what was there stays here as a separate paste. You can also pin the current text without waiting for it to be replaced.",
    emptyFiles: "Drag a file onto the room or press Upload. They go when it goes.",
    copyEntry: "Copy this paste",
    restoreEntry: "Bring it back to the editor",
    removeEntry: "Remove this paste",
    resume: "Resume",
    remove: "Remove",
    ...
    usageTitle: (used: string, limit: string) => `${used} of ${limit} across the text, the pastes and the files`,
