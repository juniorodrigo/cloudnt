...
const es = {
	...
	home: {
		...
		features: [
			...
			},
			{
				icon: "history",
				value: "sin tope",
				label: "pegadas en el historial",
				body: "Pegar algo nuevo no borra lo anterior: la sala las guarda todas mientras quepan en el gigabyte, y puedes volver a cualquiera.",
			},
			{
				icon: "devices",
				value: "16",
	...
	room: {
		...
		pin: "Guardar contenido",
		pinTip: "Alt+N · guarda este texto como una pegada aparte, para que el siguiente no lo pise",
		new: "Nuevo",
		newTip: "Vacía el editor para empezar otra cosa, sin tocar lo que ya está guardado",
		draftDoc: "Borrador nuevo",
		editingEntry: (age: string) => `Editando una pegada · ${age}`,
		closeEntry: "Cerrar la pegada y empezar un borrador nuevo",
		openTag: "abierta",
		...
		closeBody: "La sala desaparece ahora mismo con el texto, las pegadas y los archivos, y todos los conectados salen. No se puede deshacer.",
		...
		fullBody: (limit: string) => `${limit} entre el texto, las pegadas y los archivos. Puedes seguir leyéndola y descargando; para enviar algo más, borra lo que ya no necesites.`,
		...
		emptyPastes: "Cada vez que alguien pega algo distinto, lo anterior queda aquí como una pegada aparte. También puedes fijar el texto actual sin esperar a que lo reemplacen.",
		emptyFiles: "Arrastra un archivo a la sala o pulsa Subir. Se borran con ella.",
		copyEntry: "Copiar esta pegada",
		openEntry: "Abrirla en el editor",
...
const en: typeof es = {
	...
	home: {
		...
		features: [
			...
			},
			{
				...
				body:
					"The room holds 1 GB across the text, the pastes and the files, and shows you at the bottom how much you have used. The log dump, the database dump and the three certificates all fit in the same place.",
			},
			{
				icon: "history",
				value: "no cap",
	...
	room: {
		...
		new: "New",
		newTip: "Empties the editor to start something else, leaving what is already saved alone",
		draftDoc: "New draft",
		editingEntry: (age: string) => `Editing a paste · ${age}`,
		closeEntry: "Close the paste and start a new draft",
		openTag: "open",
		...
		closeBody: "The room disappears right now along with the text, the pastes and the files, and everyone connected is dropped. This cannot be undone.",
		...
		fullBody: (limit: string) => `${limit} across the text, the pastes and the files. You can still read it and download; to send anything more, delete what you no longer need.`,
		...
		emptyPastes: "Every time someone pastes something different, what was there stays here as a separate paste. You can also pin the current text without waiting for it to be replaced.",
		emptyFiles: "Drag a file onto the room or press Upload. They go when it goes.",
		copyEntry: "Copy this paste",
		openEntry: "Open it in the editor",
